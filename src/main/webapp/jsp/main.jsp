...
<div class="container">
    <!-- Заголовок "Welcome" -->
    <div class="header">
        <h1>Добро пожаловать, ${sessionScope.reader.username}!</h1>
    </div>
    ...
    <div class="columns">
        ...
        <div class="right-column">
            ...
            <div class="news-list">
                ...
                <div class="news-item">
                    <h2>Акция</h2>
                    <p>Только с 01.05.25 по 05.05.25 постоянным покупателям скидка на все книги 10%.</p>
                    <button onclick="toggleDetails(this)">Подробнее</button>
                    <div class="news-details">
                        <p><strong>Подробности:</strong> Только с 01.05.25 по 05.05.25 постоянным покупателям скидка на все книги 10%.</p>
                    </div>
                </div>

                <div class="news-item">
                    <h2>Внимание!</h2>
                    <p>Отправка всех заказов выполняется Яндекс доставкой.</p>
                    <button onclick="toggleDetails(this)">Подробнее</button>
                    <div class="news-details">
                        <p><strong>Подробности:</strong> Другие виды доставки не доступны по техническим причинам.</p>
                    </div>
                </div>

                <div class="news-item">
                    <h2>Акция: Скидки до 0%</h2>
                    <p>Специальное предложение для наших клиентов! Скидки на все товары до 3%. Успейте воспользоваться!</p>
                    <button onclick="toggleDetails(this)">Подробнее</button>
                    <div class="news-details">
                        <p><strong>Подробности:</strong> Акция действует до конца месяца. Скидки на все категории книг.</p>
                    </div>
                </div>
            </div>
        </div>
